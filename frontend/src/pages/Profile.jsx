  ...
  return (
    <div className='p-3 max-w-lg mx-auto mb-12'>
      ...
      <form onSubmit={handleUpdate} className='flex flex-col gap-5'>
        ...
        <input type='text' className='rounded-lg p-3 bg-white focus:outline-none' placeholder='username' id='username' defaultValue={currentUser.username} />

        <input type='email' className='rounded-lg p-3 bg-white focus:outline-none' placeholder='email' id='email' defaultValue={currentUser.email} default={currentUser.email} />
